...
convert -geometry 1600x1600 -density 200x200 -quality 100 migreurop/* tmp/migreurop.pdf 
...
convert -geometry 1600x1600 -density 200x200 -quality 100 externalisation/* tmp/externalisation.pdf 
...
qpdf --empty --pages tmp/migreurop.pdf tmp/actions.pdf tmp/camps.pdf tmp/externalisation.pdf tmp/morts.pdf tmp/syriens.pdf tmp/conclusion.pdf -- migreurop.pdf
